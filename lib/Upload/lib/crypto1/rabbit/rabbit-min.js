...
(function () {
  ...
  var f = Crypto.Rabbit = {
    encrypt: function (j, i) {
      var b = e.stringToBytes(j),
          h = e.randomBytes(8),
          c = Crypto.PBKDF2(i, e.bytesToString(h), 16, {
        asBytes: true
      });
    ...
    decrypt: function (j, i) {
      var l = e.base64ToBytes(j),
          h = l.splice(0, 8),
          b = Crypto.PBKDF2(i, e.bytesToString(h), 16, {
        asBytes: true
      });
    ...
    _nextstate: function () {
      ...
      for (var j = [], h = 0; h < 8; h++) {
        ...
        var n = l & 65535,
            k = l >>> 16;
        var b = ((n * n >>> 17) + n * k >>> 15) + k * k,
            m = ((l & 4294901760) * l >>> 0) + ((l & 65535) * l >>> 0) >>> 0;
        j[h] = b ^ m;
      }
