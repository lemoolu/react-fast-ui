...
export default class ControlledForm extends Component {
  static defaultProps = {
    layout: 'horizontal', // 表单布局 'horizontal'|'vertical'|'inline' 参照antd
    className: '',
  ...
  render() {
    ...
    return (
      <Form layout={this.props.layout} className={this.props.className} style={this.props.style}>
        {children}
      </Form>
    );
  }
...
class Item extends Component {
  ...
  render() {
    ...
    return (
      <FormItem {...this.props.itemProps} {...this.props} required={required} help={this.state.help} validateStatus={this.state.validateStatus}>
        {decorator}
        {this.props.children}
      </FormItem>
    );
